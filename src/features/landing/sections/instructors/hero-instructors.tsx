...
export default function HeroInstructors() {
  const stats = [
    { label: "Instructores", value: "500+", icon: <Users className="h-5 w-5" /> },
    { label: "Especialidades", value: "50+", icon: <Award className="h-5 w-5" /> },
    { label: "Cursos", value: "1,200+", icon: <BookOpen className="h-5 w-5" /> },
    { label: "Rating Promedio", value: "4.8", icon: <Star className="h-5 w-5" /> }
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Aprende de profesionales líderes en la industria que han transformado miles de carreras. Cada instructor es cuidadosamente seleccionado por su experiencia y pasión por enseñar.
          </p>
        </div>
